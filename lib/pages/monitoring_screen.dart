...
class MonitoringScreen extends StatefulWidget {
  ...
  @override
  _MonitoringScreen createState() => _MonitoringScreen();
}

class _MonitoringScreen extends State<MonitoringScreen> {
  @override
...
class _PaginatidListState extends State<PaginatidList> {
  ...
  void initState() {
    ...
    for (var _i = 0; _i <= widget.itemsCount; _i++) {
      allItemsList.add(
        PayrollItem(employee: "john smith", event: "check in", hours: _i),
      );
    }
    super.initState();
  }
