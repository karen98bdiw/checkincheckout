...
import 'package:checkincheckout/pages/parking/edit_parking_screen.dart';
...
class ParkingProfileScreen extends StatefulWidget {
  @override
  _ParkingProfileScreen createState() => _ParkingProfileScreen();
}

class _ParkingProfileScreen extends State<ParkingProfileScreen> {
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (c) => EditParkingProfileScreen()));
                  },
                  child: Container(
                    width: 40,
                    height: 40,
